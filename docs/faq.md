...
优先看本页的“推荐教程路线”里的“路线 4”，再进入 [`everything-claude-code/examples/`](https://github.com/affaan-m/ECC/tree/main/examples/) 和 [`everything-claude-code/rules/README.md`](https://github.com/affaan-m/ECC/blob/main/rules/README.md)。
